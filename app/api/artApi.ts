  ...
  endpoints: (builder) => ({
    ...
    getArtwork: builder.query<Artwork, number>({
      query: (id) => ({
        url: `artworks/${id}`,
        params: {
          fields: 'id,title,artist_title,date_display,medium_display,thumbnail,image_id',
        },
      }),
